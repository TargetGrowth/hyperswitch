...
impl<T> From<(StringMinorUnit, T)> for MercadopagoRouterData<T> {
...
impl From<MercadopagoPaymentStatus> for common_enums::AttemptStatus {
    fn from(item: MercadopagoPaymentStatus) -> Self {
        match item {
            MercadopagoPaymentStatus::Succeeded => Self::Charged,
            MercadopagoPaymentStatus::Failed => Self::Failure,
            MercadopagoPaymentStatus::Processing => Self::Authorizing,
        }
    }
}
