...
#[derive(Clone, Copy)]
struct IuguTest;
impl ConnectorActions for IuguTest {}
impl utils::Connector for IuguTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Iugu;
        api::ConnectorData {
            connector: Box::new(Iugu::new()),
            connector_name: types::Connector::Iugu,
...
static CONNECTOR: IuguTest = IuguTest {};
